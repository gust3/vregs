 ...
 * @version 	$Id: install.php 2148 2012-10-07 07:01:03Z RolandD $
 */
...
class CsviModelInstall extends JModel {
	...
	private function _loadComponents() {
		...
		$files = JFolder::files(JPATH_COMPONENT_ADMINISTRATOR.'/install', '.sql', false, false, array('.svn', 'CVS', '.DS_Store', '__MACOSX', 'availablefields_extra.sql', 'install.mysql.utf8.sql'));
		if (!empty($files)) {
