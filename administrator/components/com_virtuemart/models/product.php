 ...
 * @version $Id: product.php 6508 2012-10-08 06:57:29Z alatak $
 */
...
class VirtueMartModelProduct extends VmModel {
	...
	function __construct () {
		...
		$this->setToggleName('product_new');
		$this->setToggleName('product_last');
		$this->setToggleName('product_slider');
