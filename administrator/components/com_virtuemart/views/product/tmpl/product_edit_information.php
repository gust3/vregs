 ...
 * @version $Id: product_edit_information.php 6473 2012-09-19 09:13:07Z alatak $
 */
				...
				<table class="adminform">
					<tr class="row<?php echo $i?>">
                        ...
                        <td >
							...
							<?php echo JText::_('COM_VIRTUEMART_PRODUCT_FORM_NEW') ?>
                       		<?php echo VmHTML::checkbox('product_new', $this->product->product_new); ?>
							<?php echo JText::_('COM_VIRTUEMART_PRODUCT_FORM_LAST') ?>
                       		<?php echo VmHTML::checkbox('product_last', $this->product->product_last); ?>
							<?php echo JText::_('COM_VIRTUEMART_PRODUCT_FORM_SLIDER') ?>
                       		<?php echo VmHTML::checkbox('product_slider', $this->product->product_slider); ?>
                        </td>
...
// 						vmdebug('my rules',$this->DBTaxRules,$this->DATaxRules); echo JText::_('COM_VIRTUEMART_PRODUCT_FORM_DISCOUNT_EFFECTING').$this->DBTaxRules;  ?>
	...
	<tr>
	<td colspan="2" >
	<div style="padding-bottom:10px;padding-left:10px;">	<a href="<?php echo JRoute::_("index.php?option=com_gustvmtools&view=video&task=addvideo&product_id=".$this->product->virtuemart_product_id)?>">добавить видео</a></div>
	<div style="padding-bottom:10px;padding-left:10px;"><a href="<?php echo JRoute::_("index.php?option=com_gustvmtools&view=opisanie&task=addopisanie&product_id=".$this->product->virtuemart_product_id)?>">добавить описание</a></div>
	<fieldset>
		<legend>
