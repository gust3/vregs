...
?>
<form action="<?php echo JRoute::_('index.php?option=com_gustvmtools&view=addresses'); ?>" method="post" name="adminForm">
    <fieldset id="filter-bar">
		...
		<div class="filter-search3 fltlft">
			<label class="filter-search-lbl" for="filter_search3">Фильтр по адресу:</label>
...
<input type="hidden" name="task" value="adresses" />
