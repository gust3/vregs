...
*Cart Ajax Module
*
* @version $Id: mod_virtuemart_cart.php 6488 2012-10-01 19:29:08Z Milbo $
* @package VirtueMart
* @subpackage modules
*
...
$data->billTotal = $lang->_('COM_VIRTUEMART_CART_TOTAL').' : <strong>'. (int) $data->billTotal .' руб</strong>';
